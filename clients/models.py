...
class Client_Info(models.Model):	
	...
	support_language = models.ManyToManyField(Language, blank=True, null=True)
	domain = models.CharField(max_length=50, blank=True, null=True)
	payment_model = models.ManyToManyField(Payment_Model, blank=True, null=True)
	wallet_number = models.CharField(max_length=15, blank=True, null=True)
	custom_contact_info = models.BooleanField()
	phone_numbers = models.ManyToManyField(Phone_Number, blank=True, null=True)
