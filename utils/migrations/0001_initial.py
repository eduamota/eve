    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='utils.Location')),
            ],
        ),
        migrations.CreateModel(
            name='Skill',
        ...
        migrations.AddField(
            model_name='profile',
            name='skill',
            field=models.ManyToManyField(blank=True, to='utils.Skill'),
        ),
        migrations.AddField(
            model_name='profile',
            name='user',
